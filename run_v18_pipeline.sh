...
#   2. Run training ladder tier3 from v12c tier2 adapter using v18 corpus
#
# Usage:
#   bash run_v18_pipeline.sh [base_adapter_path]
...
OUTPUT_DIR="output/ladder_run_v18"
...
echo ""
echo "=== v18 pipeline complete. Results: $OUTPUT_DIR ==="
