#!/usr/bin/env bash
# Run the v20 regimen training pipeline.
#
...
#
# Usage:
#   bash run_v20_pipeline.sh [base_adapter_path]
...
OUTPUT_DIR="output/ladder_run_v20"

echo "=== v20 Regimen Training ==="
...
echo ""
echo "=== v20 pipeline complete. Results: $OUTPUT_DIR ==="
