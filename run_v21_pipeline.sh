#!/usr/bin/env bash
# Run the v21 regimen training pipeline.
#
...
#
# Usage:
#   bash run_v21_pipeline.sh [base_adapter_path]
...
OUTPUT_DIR="output/ladder_run_v21"

echo "=== v21 Regimen Training ==="
...
echo ""
echo "=== v21 pipeline complete. Results: $OUTPUT_DIR ==="
