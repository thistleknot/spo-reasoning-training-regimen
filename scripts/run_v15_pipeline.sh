...
#   2. Run training ladder tier3 from v12c tier2 adapter using v15 corpus
#
# Usage:
#   bash run_v15_pipeline.sh [base_adapter_path]
...
FACTS_V14="data/train_facts_verbatim_v15.jsonl"
OUTPUT_DIR="output/ladder_run_v15"
...
records = [json.loads(l) for l in Path("data/train_facts_verbatim_v15.jsonl").open()]
sample  = records[:50]
...
echo ""
echo "=== v15 pipeline complete. Results: $OUTPUT_DIR ==="
