...
#   2. Run training ladder tier3 from v12c tier2 adapter using v17 corpus
#
# Usage:
#   bash run_v17_pipeline.sh [base_adapter_path]
...
OUTPUT_DIR="output/ladder_run_v17"
...
echo ""
echo "=== v17 pipeline complete. Results: $OUTPUT_DIR ==="
